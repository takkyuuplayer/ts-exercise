...
describe("test/classes", () => {
    describe("subclass", () => {
        it("must call super before accessing instance values", () => {
            class Animal {
                ...
                public move(distanceInMeters: number = 0): number {
    ...
    describe("getter/setter", () => {
        it("runs implemented logic when accessing the property", () => {
            class User {
                private pPassword: string = "defaultPassword";
                get password() {
            ...
            expect(() => { u.password = "weak"; }).toThrowError("Password length must be more than 7");
        });
    });
